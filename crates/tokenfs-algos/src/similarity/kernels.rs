...
pub mod auto {
    ...
    pub fn dot_f32(a: &[f32], b: &[f32]) -> Option<f32> {
        ...
        {
            if super::sve::is_available() {
                // SAFETY: availability checked above; lengths match.
                return Some(unsafe { super::sve::dot_f32(a, b) });
            }
        }
        #[cfg(all(feature = "neon", target_arch = "aarch64"))]
        {
    ...
    pub fn l2_squared_f32(a: &[f32], b: &[f32]) -> Option<f32> {
        ...
        #[cfg(all(feature = "std", feature = "sve", target_arch = "aarch64"))]
        {
            if super::sve::is_available() {
                // SAFETY: availability checked above; lengths match.
                return Some(unsafe { super::sve::l2_squared_f32(a, b) });
            }
        }
        #[cfg(all(feature = "neon", target_arch = "aarch64"))]
        {
    ...
    pub fn cosine_similarity_f32(a: &[f32], b: &[f32]) -> Option<f32> {
        ...
        #[cfg(all(feature = "std", feature = "sve", target_arch = "aarch64"))]
        {
            if super::sve::is_available() {
                // SAFETY: availability checked above; lengths match.
                return Some(unsafe { super::sve::cosine_similarity_f32(a, b) });
            }
        }
        #[cfg(all(feature = "neon", target_arch = "aarch64"))]
        {
